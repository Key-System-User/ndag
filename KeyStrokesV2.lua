...
-- Instances: 110 | Scripts: 1 | Modules: 0 | Tags: 0
local G2L = {};
...
G2L["6c"]["BackgroundColor3"] = Color3.fromRGB(121, 221, 255);
...
-- StarterGui.KeystrokesV2.Frame.NameStats.UIDragDetector
G2L["6e"] = Instance.new("UIDragDetector", G2L["6c"]);
-- G2L["6e"]["BoundingUI"] = ;
G2L["6e"]["DragSpace"] = Enum.UIDragDetectorDragSpace.LayerCollector;
-- G2L["6e"]["ActivatedCursorIconContent"] = ;
-- G2L["6e"]["CursorIconContent"] = ;
G2L["6e"]["CursorIcon"] = [[rbxasset://textures/Cursors/KeyboardMouse/ArrowCursor.png]];
G2L["6e"]["ActivatedCursorIcon"] = [[rbxasset://textures/Cursors/KeyboardMouse/ArrowCursor.png]];
